			...
			<div className='container relative '>
				<div className='grid lg:grid-cols-2 gap-20'>
					...
					<div className='relative  sm:px-10 lg:px-0'>
						<img src="/img/home-3.jpg" className='w-full rounded-lg lg:h-[600px] object-cover object-center' alt="" />
						<div className='hidden sm:block absolute bottom-9 w-80 -left-2 lg:-left-40'>
							<div className='p-11  shadow-lg  bg-white rounded-xl'>
								<h4 className='text-2xl font-bold'> Habitación familiar con baño privado</h4>
								<p className='mt-3 text-lg font-light'>
									<strong className='text-3xl font-extrabold'>$149</strong> / 1 night
								</p>
